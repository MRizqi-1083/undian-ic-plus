...
<head>
    ...
    <style>
        ...
        #scene {
            ...
            margin-top: -300px;
            margin-left: -600px;
            background: url(/undian/2.jpg) no-repeat center center fixed;
...
<body>
    <div id='starter' onclick="showTime()"><img class="logo" src="{{ asset('undian/logo22.jpg') }}"></img></div>
    <div id='scene'>
        <div id='curtain'>
